...
void ACarGamePawn::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	...
	InputComponent->BindAxis("MoveForward", this, &ACarGamePawn::MoveForward);
	InputComponent->BindAxis("MoveRight", this, &ACarGamePawn::MoveRight);
	...
	InputComponent->BindAction("SwitchCamera", IE_Pressed, this, &ACarGamePawn::OnToggleCamera);

	InputComponent->BindAction("ResetVR", IE_Pressed, this, &ACarGamePawn::OnResetVR); 
}
